        ...
        <section className="py-20 md:py-28">
          <div className="container-shell grid items-start gap-12 lg:grid-cols-[1fr_1fr]">
            <div className="space-y-6">
              <h2 className="font-heading text-3xl font-black tracking-[-0.04em] text-white md:text-4xl">Kenapa Nggawe Web?</h2>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li className="flex gap-3 text-slate-300" key={item}>
            ...
            <div className="grid gap-5">
              <Card>
                <Code2 className="mb-4 text-cyan-300" size={28} />
              ...
              <Card>
                <Search className="mb-4 text-cyan-300" size={28} />
              ...
              <Card>
                <Bot className="mb-4 text-cyan-300" size={28} />
