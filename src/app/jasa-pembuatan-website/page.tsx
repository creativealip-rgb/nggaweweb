...
const data = {
  ...
  h1: "Jasa Pembuatan Website Profesional untuk Bisnis yang Ingin Dapat Lead.",
  subheadline:
    "Nggawe Web menyediakan jasa website untuk UMKM, bisnis jasa, toko online, dan perusahaan: cepat, rapi, SEO-ready, mudah dipakai tim, dan siap bantu calon pelanggan percaya.",
  ...
  faqs: [
    ...
    { question: "Berapa harga website untuk UMKM?", answer: "Harga website UMKM tergantung jumlah halaman, desain, copywriting, fitur, dan kebutuhan SEO. Landing page bisa lebih murah, sedangkan company profile dan toko online butuh scope lebih lengkap." },
    { question: "Apakah jasa website sudah termasuk SEO?", answer: "Fondasi SEO seperti struktur heading, metadata, sitemap, schema, dan speed optimization bisa disiapkan sejak awal. Untuk ranking jangka panjang, tetap perlu konten dan optimasi berkala." },
    { question: "Apakah bisa redesign website lama?", answer: "Bisa. Website lama bisa diaudit dulu dari sisi desain, speed, SEO, struktur konten, dan conversion. Setelah itu diputuskan apakah cukup redesign atau perlu rebuild." },
    { question: "Apakah ada kalkulator biaya website?", answer: "Ada. Kamu bisa membuka halaman tools website cost calculator untuk simulasi kasar sebelum konsultasi." },
  ],
  relatedServices: [
