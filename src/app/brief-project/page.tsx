            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4 rounded-2xl border border-slate-200 bg-white/[0.03] p-6">
                ...
                <ul className="space-y-3 text-sm text-slate-600">
                  <li className="flex gap-3"><span className="font-mono text-blue-600">01</span> Kami review kebutuhan dan website kamu</li>
                  <li className="flex gap-3"><span className="font-mono text-blue-600">02</span> Kami kasih rekomendasi solusi dan estimasi</li>
                  <li className="flex gap-3"><span className="font-mono text-blue-600">03</span> Kami follow-up via WhatsApp/email dalam 1x24 jam</li>
                </ul>
              </div>
            </div>
