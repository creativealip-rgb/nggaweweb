        ...
        <section className="py-20 md:py-28">
          <div className="container-shell grid items-start gap-12 lg:grid-cols-[1fr_1.2fr]">
            <div className="space-y-10">
              <div>
                <h2 className="font-heading text-2xl font-bold tracking-[-0.04em] text-white">Yang kami cek</h2>
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
                <p className="text-sm text-slate-400">
                  <span className="font-bold text-white">Catatan:</span> Audit gratis bersifat ringkas. Untuk audit mendalam, kami bisa siapkan technical SEO dan conversion audit terpisah.
                </p>
              </div>
            </div>
