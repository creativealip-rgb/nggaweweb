...
const data = {
  ...
  pillarSections: [
    ...
    { title: "Konten yang punya information gain", body: "Google makin menghargai konten yang tidak hanya merangkum ulang hasil pencarian. Information gain berarti halaman memberi tambahan nilai yang tidak mudah ditemukan di halaman lain. Untuk bisnis, nilai tambahan bisa berupa pengalaman project, contoh audit, checklist sendiri, insight dari data Search Console, atau studi kasus klien.", points: ["Tambahkan contoh nyata dari project.", "Gunakan tabel dan checklist praktis.", "Jelaskan keputusan, bukan cuma definisi.", "Update artikel dengan data terbaru dari GSC.", "Tulis berdasarkan pengalaman melayani bisnis, bukan rewrite artikel lain."] },
    { title: "Cara menghindari keyword cannibalization", body: "Keyword cannibalization terjadi saat beberapa halaman menarget intent yang sama sehingga saling bersaing di Google. Solusinya adalah mapping keyword sejak awal. Halaman jasa SEO menarget keyword utama dan transaksional, sementara artikel seperti belajar SEO, SEO lokal, dan optimasi Google Maps menarget pertanyaan spesifik.", points: ["Satu keyword utama untuk satu halaman utama.", "Artikel cluster fokus subtopik yang lebih sempit.", "Gunakan canonical jika ada konten mirip.", "Gabungkan artikel yang terlalu tumpang tindih.", "Pastikan internal link mengarah ke halaman yang ingin diprioritaskan."] },
    { title: "SEO lokal untuk bisnis jasa", body: "Untuk bisnis yang melayani area tertentu, SEO lokal bisa memberi hasil lebih cepat daripada keyword nasional. Optimasi mencakup Google Business Profile, review, halaman layanan dengan konteks lokasi, citation lokal, dan konten yang menjawab kebutuhan pelanggan di area tersebut.", points: ["Lengkapi kategori, layanan, jam buka, dan foto di Google Business Profile.", "Kumpulkan review asli dari pelanggan.", "Pastikan nama, alamat, dan nomor telepon konsisten.", "Buat konten yang relevan dengan kota atau area layanan.", "Pantau pencarian di Google Maps dan organic search."] },
  ],
  clusterLinks: [
